...
const TableBackBTTX = ({dataCasa,dataVisitante,title}) => {
    ...
    const sortCS = (rowA, rowB) => {
        const a = rowA.percentual_cs;
        const b = rowB.percentual_cs;
    ...
    const sortAM = (rowA, rowB) => {
        const a = rowA.percentual_am;
        const b = rowB.percentual_am;
    ...
    const sortFTS = (rowA, rowB) => {
        const a = rowA.percentual_fts;
        const b = rowB.percentual_fts;
    ...
    const columns = [
        ...
        {
            name: 'CS',
            selector: row => row.percentual_cs+'%',
            center: true,
            width:'100px',
            hide: 'sm',
            sortable: true,
        ...
        {
            name: 'AM',
            selector: row => row.percentual_am+'%',
            width:'100px',
            center: true,
            hide: 'sm',
            sortable: true,
        ...
        {
            name: 'FTS',
            selector: row => row.percentual_fts+'%',
            width:'100px',
            center: true,
            hide: 'sm',
            sortable: true,
            sortFunction: sortFTS,
        },
        {
            name: 'Lucro',
