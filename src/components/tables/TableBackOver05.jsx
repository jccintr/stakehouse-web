...
const TableBackOver05 = ({dataCasa,dataVisitante,title}) => {
    ...
    const sort05 = (rowA, rowB) => {
        const a = rowA.percentual_over_05;
        const b = rowB.percentual_over_05;
    ...
    const columns = [
        ...
        {
            name: '+0.5FT',
            selector: row => row.percentual_over_05+'%',
            center: true,
            width:'100px',
            hide: 'sm',
            sortable: true,
...
export default TableBackOver05