...
const TableBackUnder35 = ({dataCasa,dataVisitante,title}) => {
    ...
    const sort35 = (rowA, rowB) => {
        const a = rowA.percentual_under_35;
        const b = rowB.percentual_under_35;
    ...
    const sort45 = (rowA, rowB) => {
        const a = rowA.percentual_under_15;
        const b = rowB.percentual_under_15;
    ...
    const sort25 = (rowA, rowB) => {
        const a = rowA.percentual_under_25;
        const b = rowB.percentual_under_25;
    ...
    const columns = [
        ...
        {
            name: '+2.5FT',
            selector: row => row.percentual_under_25+'%',
            center: true,
            width:'100px',
            hide: 'sm',
            sortable: true,
        ...
        {
            name: '+3.5FT',
            selector: row => row.percentual_under_35+'%',
            width:'100px',
            center: true,
            hide: 'sm',
            sortable: true,
        ...
        {
            name: '+4.5FT',
            selector: row => row.percentual_under_45+'%',
            width:'100px',
            center: true,
            hide: 'sm',
            sortable: true,
...
export default TableBackUnder35